...
module.exports = {
    async login(req, res, next) {
        ...
        if (!email || !password || email == "undefined" || password == "undefined") return res.status(401).json({ message: "INVALID_CREDENTIALS" });
        ...
        const token = jwt.sign({ email }, secret, { expiresIn: 1000000 });
